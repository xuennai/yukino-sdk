# Yukino SDK
Yukino SDK 是一个高性能的移动端漫画/书籍解析方案，集成 C++ 原生引擎，旨在为 Android 开发者提供极致的文档渲染体验。

## 🚀 特性
* **双引擎支持**：集成 **PDFium** (PDF) 与 **libmobi** (Mobi/Azw3) 解析内核。
...
| 模块名 | 对应内核 | 说明 |
|---|---|---|
| yukino_pdf | PDFium | 负责 PDF 渲染与页面提取 |
...
- **[PDFium](https://pdfium.googlesource.com/pdfium)**  
  提供了高效的 PDF 渲染能力。相关二进制库已通过 [pdfium-binaries](https://github.com/bblanchon/pdfium-binaries) 仓库编译与发布。  
  最新版本信息：[releases/latest](https://github.com/bblanchon/pdfium-binaries/releases/latest)。
